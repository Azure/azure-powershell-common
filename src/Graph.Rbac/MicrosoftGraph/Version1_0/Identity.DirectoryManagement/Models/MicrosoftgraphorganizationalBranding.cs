...
namespace Microsoft.Azure.Commands.Common.MSGraph.Version1_0.Identity.DirectoryManagement.Models
{
    ...
    public partial class MicrosoftgraphorganizationalBranding : MicrosoftgraphorganizationalBrandingProperties
    {
        /// <summary>
        /// Initializes a new instance of the
        /// MicrosoftgraphorganizationalBranding class.
        /// </summary>
        ...
        /// characters.</param>
        /// <param name="localizations">Add different branding based on a
        /// locale.</param>
        public MicrosoftgraphorganizationalBranding(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), string id = default(string), string backgroundColor = default(string), byte[] backgroundImage = default(byte[]), string backgroundImageRelativeUrl = default(string), byte[] bannerLogo = default(byte[]), string bannerLogoRelativeUrl = default(string), IList<string> cdnList = default(IList<string>), string signInPageText = default(string), byte[] squareLogo = default(byte[]), string squareLogoRelativeUrl = default(string), string usernameHintText = default(string), IList<MicrosoftgraphorganizationalBrandingLocalization> localizations = default(IList<MicrosoftgraphorganizationalBrandingLocalization>))
        ...
        /// <summary>
        /// Gets or sets add different branding based on a locale.
        /// </summary>
        [JsonProperty(PropertyName = "localizations")]
        public IList<MicrosoftgraphorganizationalBrandingLocalization> Localizations { get; set; }
