...
{
    public class DefaultSanitizerSettings : ISanitizerSettings
    {
        ...
        public bool HasSensitiveData(string data, out string sanitizedData)
        {
        ...
        public bool RequireSecretsRedaction(string invocationName = null)
        {
            return false;
        }
    }
