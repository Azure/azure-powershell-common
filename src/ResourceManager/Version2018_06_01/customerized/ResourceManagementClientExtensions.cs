...
using IRMClient = Microsoft.Azure.Management.Internal.ResourceManager.Version2018_05_01.IResourceManagementClient;

namespace Microsoft.Azure.Management.Internal.Resources.Utilities.Version2018_06_01
{
    public static class ResourceManagementClientExtensions
    {
        public static List<GenericResource> FilterResources(this IRMClient client, FilterResourcesOptions options)
        {
            ...
            else
            {
                ...
                {
                    Rest.Azure.IPage<GenericResource> result = client.Resources.ListByResourceGroup(options.ResourceGroup, new Rest.Azure.OData.ODataQuery<GenericResourceFilter>(r => r.ResourceType == options.ResourceType));
