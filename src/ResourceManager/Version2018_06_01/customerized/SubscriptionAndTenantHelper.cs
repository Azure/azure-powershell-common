...
namespace Microsoft.Azure.Commands.ResourceManager.Common.Utilities.Version2018_06_01
{
    public class SubscriptionAndTenantHelper
    {
            ...
            string tenantId)
        {
            ...
            return ListAllSubscriptions(subscriptionClient, context);
        }
        ...
        public static IEnumerable<AzureSubscription> ListAllSubscriptions(SubscriptionClient client, IAzureContext context)
        {
            var subscriptions = client.Subscriptions;
            return new GenericPageEnumerable<Subscription>(subscriptions.List, subscriptions.ListNext, ulong.MaxValue, 0).Select(s => ToAzureSubscription(s, context));
        }
