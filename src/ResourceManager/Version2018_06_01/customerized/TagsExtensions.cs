...
namespace Microsoft.Azure.Commands.ResourceManager.Common.Tags.Version2018_06_01
{
    public static class TagsExtensions
    {
        ...
        private static TagValue EmptyTagValue
        {
            get
            {
                return new TagValue(string.Empty, string.Empty, new TagCount { Type = string.Empty });
            }
        }
